 ...
 * @param comment 内容
 */
export function insertComment(r,c,comment){
    luckysheetPostil.newPs(r,c,comment);    
}
 ...
 * @param c 列
 */
export function delComment(r,c){
    luckysheetPostil.delPs(r,c);
}

/**
 * 显示批注
 */
export function showHideAllComment(){
 ...
 * 批注大小拖动隐藏
 */
export function hideResizeComment(r,c){
    luckysheetPostil.hideResize(r,c);
}
