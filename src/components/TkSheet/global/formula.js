...
const luckysheetformula = {
    ...
    searchFunctionHTML: function(list) {
        ...
        if ($("#luckysheet-formula-search-c").length == 0) {
            $("#" + Store.container).parent().append(_this.searchHTML);
            $("#luckysheet-formula-search-c")
    ...
    updatecell: function(r, c, value, isRefresh = true) {
        ...
        setTimeout(() => {
            ...
            method.createHookFunction("cellUpdated", r, c, JSON.parse(oldValue), currentCell, isRefresh);
        }, 0);
    ...
    cellFocus:function(row_index, col_index) {
        ...
        if(file.calcChain){
            ...
            if(txt && txt.indexOf('=GET_AIRTABLE_DATA') === 0){
