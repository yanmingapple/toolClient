...
export default function luckysheetcreatedom(colwidth, rowheight, data, menu, title) {
    ...
    //新建行菜单
    $("#" + Store.container).parent().append(maskHTML);
    $("#" + Store.container).parent().append(colsmenuHTML);
    $("#" + Store.container).parent().append(rightclickHTML());
    $("#" + Store.container).parent().append(inputHTML);
    $("#" + Store.container).parent().append(replaceHtml(filtermenuHTML(), { "menuid": "filter" }));
    $("#" + Store.container).parent().append(replaceHtml(filtersubmenuHTML(), { "menuid": "filter" }));
    $("#" + Store.container).parent().append(sheetconfigHTML());
