...
const dataVerificationCtrl = {
    ...
    init: function(){
        ...
        //单元格数据验证 类型是 下拉列表
        $("#" + Store.container).parent().off("click.dropdownBtn").on("click.dropdownBtn", "#luckysheet-dataVerification-dropdown-btn", function(e) {
            _this.dropdownListShow();
            e.stopPropagation();
        });
        $("#" + Store.container).parent().off("click.dropdownListItem").on("click.dropdownListItem", "#luckysheet-dataVerification-dropdown-List .dropdown-List-item", function(e) {
            var $item = $(this);
        ...
        //单元格范围
        $("#" + Store.container).parent().off("click.dvRange").on("click.dvRange", "#data-verification-range .fa-table", function(e) {
        ...
        $("#" + Store.container).parent().off("click.dvRange2").on("click.dvRange2", "#luckysheet-dataVerification-dialog .show-box-item-dropdown .range .fa-table", function(e) {
            $("#luckysheet-dataVerification-dialog").hide();
            ...
            if(!range && range.length > 0 && range[0].sheetIndex != Store.currentSheetIndex){
                sheetmanage.changeSheetExec(range[0].sheetIndex);
            }
        ...
        $("#" + Store.container).parent().off("click.dvRangeConfirm").on("click.dvRangeConfirm", "#luckysheet-dataVerificationRange-dialog-confirm", function(e) {
        ...
        $("#" + Store.container).parent().off("click.dvRangeClose").on("click.dvRangeClose", "#luckysheet-dataVerificationRange-dialog-close", function(e) {
            $("#luckysheet-dataVerificationRange-dialog").hide();
            $("#luckysheet-modal-dialog-mask").show();
            $("#luckysheet-dataVerification-dialog").show();
        ...
        $("#" + Store.container).parent().on("click", "#luckysheet-dataVerificationRange-dialog .luckysheet-modal-dialog-title-close", function(e) {
            $("#luckysheet-dataVerificationRange-dialog").hide();
            $("#luckysheet-modal-dialog-mask").show();
            $("#luckysheet-dataVerification-dialog").show();
        ...
        //验证条件 下拉框
        $("#" + Store.container).parent().off("change.typeSelect").on("change.typeSelect", "#data-verification-type-select", function(e) {
        ...
        $("#" + Store.container).parent().off("change.numberSelect").on("change.numberSelect", "#data-verification-number-select", function(e) {
            $("#luckysheet-dataVerification-dialog .show-box-item-number .input").hide();
        ...
        // 文本长度选择变化
        $("#" + Store.container).parent().off("change.textLengthSelect").on("change.textLengthSelect", "#data-verification-textLength-select", function(e) {
            $("#luckysheet-dataVerification-dialog .show-box-item-textLength .input").hide();
        ...
        $("#" + Store.container).parent().off("change.dateSelect").on("change.dateSelect", "#data-verification-date-select", function(e) {
            $("#luckysheet-dataVerification-dialog .show-box-item-date .input").hide();
        ...
        //选中单元格时显示提示语
        $("#" + Store.container).parent().off("change.hintShow").on("change.hintShow", "#data-verification-hint-show", function(e) {
            if(this.checked){
        ...
        //确认按钮
        $("#" + Store.container).parent().off("click.dvSaveConfirm").on("click.dvSaveConfirm", "#luckysheet-dataVerification-dialog-confirm", function(e) {
        ...
        //删除验证按钮
        $("#" + Store.container).parent().off("click.delete").on("click.delete", "#luckysheet-dataVerification-dialog-delete", function(e) {
            let rangeTxt = $("#luckysheet-dataVerification-dialog #data-verification-range input").val().trim();
            let range = _this.getRangeByTxt(rangeTxt);
        ...
        //info提示弹框 关闭
        $("#" + Store.container).parent().on("click", "#luckysheet-info .luckysheet-modal-dialog-title-close, #luckysheet-info .luckysheet-model-close-btn", function(e) {
