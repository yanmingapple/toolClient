...
import { isRealNull, hasPartMC,isCellEditMode, isEditMode, checkIsAllowEdit } from "../global/validate";
...
export default function luckysheetHandler() {
    ...
    $("#luckysheet-cell-main, #luckysheetTableContent")
        ...
        .mouseup(function(event) {
            if (event.which == "3") {
                ...
                $("#luckysheet-cols-rows-data .luckysheet-menuseparator").show();
                $("#luckysheet-cols-rows-handleincell .luckysheet-menuseparator").show();
                ...
                if (obj_s["row"] != null && obj_s["row"][0] == 0 && obj_s["row"][1] == Store.flowdata.length - 1) {
                    ...
                    $("#luckysheet-cols-rows-add .luckysheet-menuseparator").show();

                    // 自定义右键菜单：向左向右增加列，删除列，隐藏显示列，设置列宽
                    cellRightClickConfig.insertColumn ? $("#luckysheet-top-left-add-selected").show():$("#luckysheet-top-left-add-selected").hide();
          
                    cellRightClickConfig.insertColumn ? $("#luckysheet-bottom-right-add-selected").show():$("#luckysheet-bottom-right-add-selected").hide();
                    cellRightClickConfig.deleteColumn ? $("#luckysheet-del-selected").show():$("#luckysheet-del-selected").hide();

                    cellRightClickConfig.hideColumn ? $("#luckysheet-hide-selected").show():$("#luckysheet-hide-selected").hide();

                    cellRightClickConfig.hideColumn ? $("#luckysheet-show-selected").show():$("#luckysheet-show-selected").hide();

                    cellRightClickConfig.columnWidth ? $("#luckysheet-column-row-width-selected").show():$("#luckysheet-column-row-width-selected").hide();
                    ...
                    if (!cellRightClickConfig.copy && !cellRightClickConfig.copyAs && !cellRightClickConfig.paste) {
                        $("#luckysheet-cols-rows-add .luckysheet-menuseparator").hide();
                        ...
                        if (
                            ...
                            $("#luckysheet-cols-rows-data .luckysheet-menuseparator").hide();
                        }
                    }
                    ...
                    cellRightClickConfig.insertRow
                        ?  $("#luckysheet-top-left-add-selected").show()
                        : $("#luckysheet-top-left-add-selected").hide();
                   cellRightClickConfig.insertRow
                        ?  $("#luckysheet-bottom-right-add-selected").show()
                        :  $("#luckysheet-bottom-right-add-selected").hide();
                   cellRightClickConfig.deleteRow ?  $("#luckysheet-del-selected").show() :  $("#luckysheet-del-selected").hide();
                   cellRightClickConfig.hideRow ?  $("#luckysheet-hide-selected").show() :  $("#luckysheet-hide-selected").hide();
                   cellRightClickConfig.hideRow ? $("#luckysheet-show-selected").show() : $("#luckysheet-show-selected").hide(0);
                   cellRightClickConfig.rowHeight
                        ? $("#luckysheet-column-row-width-selected").show()
                        : $("#luckysheet-column-row-width-selected").hide();
                    ...
                    if (!cellRightClickConfig.copy && !cellRightClickConfig.copyAs && !cellRightClickConfig.paste) {
                        $("#luckysheet-cols-rows-handleincell .luckysheet-menuseparator").hide();
        ...
        .dblclick(function(event) {
            ...
            //禁止前台编辑(只可 框选单元格、滚动查看表格)
            if (!Store.allowEdit || isEditMode() || !isCellEditMode()) {
                return;
            }
    ...
    //表格mousemove
    $("#" + Store.container).parent().on("mousemove.luckysheetEvent", function(event) {
    ...
    //表格mouseup
    $("#" + Store.container).parent().on("mouseup.luckysheetEvent", function(event) {
    ...
    //截图下载
    $("#" + Store.container).parent().on("click.luckysheetEvent", "a.download", function() {
    ...
    //模态框拖动
    $("#" + Store.container).parent().on("mousedown.luckysheetEvent", "div.luckysheet-modal-dialog", function(e) {
    ...
    //粘贴事件处理
    $("#" + Store.container).parent().on("paste.luckysheetEvent", function(e) {
         if (isEditMode()  || !isCellEditMode()) {
            //此模式下禁用粘贴
            return;
        }
        if (selection.isPasteAction) {
            ...
            if (
                ...
                tkMessage.err("题库在线表格，暂时不支持图片插入。");
