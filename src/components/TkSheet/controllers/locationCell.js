...
const luckysheetLocationCell = {
    ...
    init: function(){
        ...
        $("#" + Store.container).parent().on("click", "#luckysheet-locationCell-dialog .listItem input:radio", function(e){
        ...
        $("#" + Store.container).parent().off("click.locationCellConfirm").on("click.locationCellConfirm", "#luckysheet-locationCell-dialog #luckysheet-locationCell-dialog-confirm", function(){
