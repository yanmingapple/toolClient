...
export function zoomInitial(){
    ...
    $("#luckysheet-zoom-cursor").mousedown(function(e){
        ...
        $("#" + Store.container).parent().off("mousemove.zoomCursor").on("mousemove.zoomCursor",function(event){
        ...
        $("#" + Store.container).parent().off("mouseup.zoomCursor").on("mouseup.zoomCursor",function(event){
            $("#" + Store.container).parent().off(".zoomCursor");
