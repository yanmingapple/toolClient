...
const luckysheetDropCell = {
    ...
    createIcon: function(){
        ...
        $("#luckysheet-dropCell-icon").mouseover(function(){
            ...
            $("#" + Store.container).parent().append(replaceHtml(_this.typeListHtml,{
        ...
        //点击数据填充类型
        $("#" + Store.container).parent().off("click.dCtypeList").on("click.dCtypeList", "#luckysheet-dropCell-typeList .luckysheet-cols-menuitem", function(){
