...
const pivotTable = {
    ...
    initialPivotManage: function(restore) {
        ...
        if (_this.initial) {
            ...
            $("#" + Store.container).parent().append(luckysheetPivotTableHTML());
            $("#luckysheet-modal-dialog-slider-close").click(function() {
                $("#luckysheet-modal-dialog-slider-pivot").hide();
                luckysheetsizeauto();
            });

            $("#" + Store.container).parent().append(
            ...
            $("#" + Store.container).parent().append(replaceHtml(filtermenuHTML(), { menuid: "pivotTableFilter" }));
            $("#" + Store.container).parent().append(replaceHtml(filtersubmenuHTML(), { menuid: "pivotTableFilter" }));
            $("#" + Store.container).parent().append(pivottableconfigHTML());
            $("#" + Store.container).parent().append(pivottablesumHTML());
