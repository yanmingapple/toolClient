...
const insertFormula = {
    init: function(){
        ...
        $("#" + Store.container).parent().off("keyup.fxSFLI").on("keyup.fxSFLI", "#searchFormulaListInput", function(){
        ...
        $("#" + Store.container).parent().off("change.fxFormulaTS").on("change.fxFormulaTS", "#formulaTypeSelect", function(){
            let type = $("#formulaTypeSelect option:selected").val();
            _this.formulaListByType(type);
        });

        $("#" + Store.container).parent().off("click.fxListbox").on("click.fxListbox", "#formulaTypeList .listBox", function(){
            $(this).addClass("on").siblings().removeClass("on");
        });

        //选择公式后弹出参数栏弹框
        $("#" + Store.container).parent().off("click.fxFormulaCf").on("click.fxFormulaCf", "#luckysheet-search-formula-confirm", function(){
        ...
        //公式参数框
        $("#" + Store.container).parent().off("focus.fxParamInput").on("focus.fxParamInput", "#luckysheet-search-formula-parm .parmBox input", function(){
        ...
        $("#" + Store.container).parent().off("blur.fxParamInput").on("blur.fxParamInput", "#luckysheet-search-formula-parm .parmBox input", function(){
            let txt = $(this).val();
        ...
        $("#" + Store.container).parent().off("keyup.fxParamInput").on("keyup.fxParamInput", "#luckysheet-search-formula-parm .parmBox input", function(){
            //参数选区显示，参数值显示
            _this.parmTxtShow($(this).val());
        ...
        //点击图标选取数据范围
        $("#" + Store.container).parent().off("click.fxParamI").on("click.fxParamI", "#luckysheet-search-formula-parm .parmBox i", function(){
            ...
            let scrollLeft = $("#" + Store.container).parent().scrollLeft(), scrollTop = $("#" + Store.container).parent().scrollTop();
        ...
        //点击确定
        $("#" + Store.container).parent().off("click.fxParamCf").on("click.fxParamCf", "#luckysheet-search-formula-parm-confirm", function(){
            $("#luckysheet-wa-functionbox-confirm").click();
        });

        //选取范围后传回参数栏弹框
        $("#" + Store.container).parent().off("click.fxParamSelectCf").on("click.fxParamSelectCf", "#luckysheet-search-formula-parm-select-confirm", function(){
