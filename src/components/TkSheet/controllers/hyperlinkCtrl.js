...
const hyperlinkCtrl = {
    ...
    init: function (){
        ...
        //链接类型
        $("#" + Store.container).parent().off("change.linkType").on("change.linkType", "#luckysheet-insertLink-dialog-linkType", function(e){
        ...
        //确认按钮
        $("#" + Store.container).parent().off("click.confirm").on("click.confirm", "#luckysheet-insertLink-dialog-confirm", function(e){
