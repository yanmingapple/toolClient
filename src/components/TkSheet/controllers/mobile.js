...
export default function mobileinit(){
    ...
    let luckysheet_touchmove_status = false,
        ...
        _scrollTimer = null;
    $("#" + Store.container).parent().on("touchstart", "#luckysheet-grid-window-1", function(event){
    ...
    $("#" + Store.container).parent().on("touchmove", "#luckysheet-grid-window-1", function(event){
    ...
    $("#" + Store.container).parent().on("touchend", function(event){
    ...
    //滑动选择选区
    $("#" + Store.container).parent().on("touchstart", ".luckysheet-cs-touchhandle", function(event){
