...
const luckysheetMoreFormat = {
    ...
    init: function(){
        ...
        //选择格式
        $("#" + Store.container).parent().on("click", "#luckysheet-moreFormat-dialog .listbox .listItem", function(){
            $(this).addClass("on").siblings().removeClass("on");
        });

        //确定
        $("#" + Store.container).parent().off("click.moreFormatConfirm").on("click.moreFormatConfirm", "#luckysheet-moreFormat-dialog #luckysheet-moreFormat-dialog-confirm", function(){
