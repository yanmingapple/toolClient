    ...
    initialMenuButton: function() {
        ...
        $("#luckysheet-icon-fmt-other").click(function() {
            ...
            if ($menuButton.length == 0) {
                ...
                $("#" + Store.container).parent().append(menu + submenu);
        ...
        $("#luckysheet-icon-font-family")
            ...
            .click(function() {
                ...
                if ($menuButton.length == 0) {
                    ...
                    $("#" + Store.container).parent().append(menu);
        ...
        $("#luckysheet-icon-border-menu").click(function() {
            ...
            if ($menuButton.length == 0) {
                ...
                $("#" + Store.container).parent().append(menu + colormenu + submenu);
        ...
        $("#luckysheet-icon-conditionformat").click(function() {
            ...
            if ($menuButton.length == 0) {
                ...
                $("#" + Store.container).parent().append(menu + submenu + submenu2 + submenu3 + submenu4 + submenu6);
