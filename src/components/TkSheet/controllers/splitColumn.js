...
const luckysheetSplitColumn = {
    ...
    init: function(){
        ...
        //数据预览
        $("#" + Store.container).parent().off("change.SPCinpcheckbox").on("change.SPCcheckbox", "#luckysheet-splitColumn-dialog .box input[type='checkbox']", function(){
            let regStr = _this.getRegStr();
            let dataArr = _this.getDataArr(regStr);
            _this.dataPreview(dataArr);
        });
        $("#" + Store.container).parent().off("keyup.SPCinptext").on("keyup.SPCinptext", "#luckysheet-splitColumn-dialog .box input[type='text']", function(){
        ...
        //确定按钮
        $("#" + Store.container).parent().off("click.SPCconfirm").on("click.SPCconfirm", "#luckysheet-splitColumn-dialog #luckysheet-splitColumn-dialog-confirm", function(){
    ...
    getRegStr: function(){
        ...
        $("#luckysheet-splitColumn-dialog .box input[type='checkbox']:checked").each(function(i, e){
            ...
            else if($id == "splitColumn_type_05"){ //其他
