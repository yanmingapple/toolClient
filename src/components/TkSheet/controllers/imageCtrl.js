...
const imageCtrl = {
    ...
    sliderHtmlShow: function() {
        ...
        $("#" + Store.container).parent().append(sliderHtml);
        luckysheetsizeauto();
    ...
    init: function() {
        ...
        //边框选择颜色 确定 
        $("#" + Store.container).parent().off("click.selectColorConfirm").on("click.selectColorConfirm", "#luckysheet-imageCtrl-colorSelect-dialog-confirm", function(){
