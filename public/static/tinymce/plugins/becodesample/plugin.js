  ...
  var hljs = function() {
    ...
    function Q(e) {
        ...
        function t(i, s) {
            ...
            s && (i.begin || (i.begin = /\B|\b/),
            o.beginRe = n(o.begin),
            i.end || i.endsWithParent || (i.end = /\B|\b/),
            i.end && (o.endRe = n(o.end)),
            o.terminatorEnd = d(o.end) || "",
            i.endsWithParent && s.terminatorEnd && (o.terminatorEnd += (i.end ? "|" : "") + s.terminatorEnd)),
            i.illegal && (o.illegalRe = n(i.illegal)),
            i.contains || (i.contains = []),
            i.contains = [].concat(...i.contains.map((e=>(e=>(e.variants && !e.cachedVariants && (e.cachedVariants = e.variants.map((n=>r(e, {
                variants: null
            }, n)))),
            e.cachedVariants ? e.cachedVariants : X(e) ? r(e, {
                starts: e.starts ? r(e.starts) : null
            }) : Object.isFrozen(e) ? r(e) : e))("self" === e ? i : e)))),
    ...
    var ne = (e=>{
        ...
        function f(e, t, i, r) {
            ...
            function g() {
                null != O.subLanguage ? (()=>{
                    ...
                    if ("string" == typeof O.subLanguage) {
                        ...
                        e = E(S, O.subLanguage.length ? O.subLanguage : null);
            ...
            function m(e, n, t) {
                ...
                if (e.endsWithParent)
                    return m(e.parent, n, t)
            }
            function p(e) {
                return 0 === O.matcher.regexIndex ? (S += e[0],
                1) : (R = !0,
                0)
            }
            function _(e) {
            ...
            function y(n, r) {
                ...
                if ("begin" === h.type && "end" === r.type && h.index === r.index && "" === o) {
                    if (S += t.slice(r.index, r.index + 1),
                    !s) {
        ...
        function E(e, t) {
            ...
            const a = (e=>{
              ...
              , i = t.filter(v).filter(O).map((n=>f(n, e, !1)));
            i.unshift(a);
            const r = i.sort(((e,n)=>{
        ...
        const n = e.regex
          ...
          , a = {
            ...
            isTrulyOpeningTag: (e,n)=>{
                ...
                (i = e.input.substr(t).match(/^\s+extends\s+/)) && 0 === i.index && n.ignoreMatch()
            }
        }
          , i = {
            $pattern: be,
