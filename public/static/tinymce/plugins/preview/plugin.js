...
(function () {
    ...
    var getPreviewHtml = function (editor) {
      ...
      var showContent = '<div style="width: 21cm;min-height: 100%!important;padding: 0!important; margin: 0 auto;background-color: #fff;"><div style="margin:0 3.18cm;">';    
   
      var previewHtml = '<!DOCTYPE html>' + '<html>' + '<head>' + headHtml + '</head>' + '<body id="' + encode(bodyId) + '" class="mce-content-body ' + encode(bodyClass) + '" style="background-color: #000000;"' + dirAttr + '>' + showContent + editor.getContent() + preventClicksOnLinksScript + '</div></div></body>' + '</html>';
      return previewHtml;
    };
