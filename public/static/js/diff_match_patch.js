(function() {
    ...
    diff_match_patch.prototype.diff_cleanupSemantic = function(a) {
        ...
        for (f = 1; f < a.length;) {
            if (-1 == a[f - 1][0] && 1 == a[f][0]) {
                ...
                if (d >= e) { if (d >= b.length / 2 || d >= c.length / 2) a.splice(f, 0, [0, c.substring(0, d)]), a[f - 1][1] = b.substring(0, b.length - d), a[f + 1][1] = c.substring(d), f++ } else if (e >= b.length / 2 || e >= c.length / 2) a.splice(f, 0, [0, b.substring(0, e)]), a[f - 1][0] = 1, a[f - 1][1] = c.substring(0, c.length - e), a[f + 1][0] = -1, a[f + 1][1] = b.substring(e), f++;
                f++
            }
            f++
        }
    ...
    diff_match_patch.prototype.diff_prettyHtml = function(a) {
        for (var b = [], c = /&/g, d = /</g, e = />/g, f = /\n/g, g = 0; g < a.length; g++) {
            ...
            switch (h) {
                case 1:
                    b[g] = '<ins style="background:#ddfade;">' + j + "</ins>";
                    break;
                case -1:
                    b[g] = '<del style="background:#ffe7e7;">' + j + "</del>";
                    break;
                case 0:
                    b[g] = "<span>" + j + "</span>"
            }
    ...
    diff_match_patch.prototype.diff_fromDelta = function(a, b) {
        for (var c = [], d = 0, e = 0, f = b.split(/\t/g), g = 0; g < f.length; g++) {
            ...
            switch (f[g].charAt(0)) {
                case "+":
                    try { c[d++] = [1, decodeURI(h)] } catch (j) { throw Error("Illegal escape in diff_fromDelta: " + h); }
                    break;
                case "-":
                case "=":
                    var i = parseInt(h, 10);
    ...
    diff_match_patch.prototype.patch_apply = function(a, b) {
        ...
        for (var d = 0, e = [], f = 0; f < a.length; f++) {
            var g = a[f].start2 + d,
                ...
                j, i = -1;
            if (h.length > this.Match_MaxBits) { if (j = this.match_main(b, h.substring(0, this.Match_MaxBits), g), -1 != j && (i = this.match_main(b, h.substring(h.length - this.Match_MaxBits), g + h.length - this.Match_MaxBits), -1 == i || j >= i)) j = -1 } else j = this.match_main(b, h, g);
    ...
    diff_match_patch.prototype.patch_fromText = function(a) {
        ...
        for (var c = 0, d = /^@@ -(\d+),?(\d*) \+(\d+),?(\d*) @@$/; c < a.length;) {
            ...
            for (c++; c < a.length;) {
                e = a[c].charAt(0);
                try { var g = decodeURI(a[c].substring(1)) } catch (h) { throw Error("Illegal escape in patch_fromText: " + g); }
